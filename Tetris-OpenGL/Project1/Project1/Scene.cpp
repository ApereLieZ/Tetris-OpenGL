...
namespace TetrisGame {
    ...
    void Scene::on_paint() {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            switch (logic.typeOfTetramino+1)
            {
            case 1: Cube((logic.a[i].y) - (float(coll) / 2 - 0.5), 0, (logic.a[i].x) - (float(row) / 2), 0.95, 0.95, 0.95, diffBlue, ambiBlue, specBlue).draw(); break;
            case 2: Cube((logic.a[i].y) - (float(coll) / 2 - 0.5), 0, (logic.a[i].x) - (float(row) / 2), 0.95, 0.95, 0.95, diffGreen, ambiGreen, specGreen).draw(); break;
            case 3: Cube((logic.a[i].y) - (float(coll) / 2 - 0.5), 0, (logic.a[i].x) - (float(row) / 2), 0.95, 0.95, 0.95, diffRed, ambiRed, specRed).draw(); break;
            case 4: Cube((logic.a[i].y) - (float(coll) / 2 - 0.5), 0, (logic.a[i].x) - (float(row) / 2), 0.95, 0.95, 0.95, diffYellow, ambiYellow, specYellow).draw(); break;
            case 5: Cube((logic.a[i].y) - (float(coll) / 2 - 0.5), 0, (logic.a[i].x) - (float(row) / 2), 0.95, 0.95, 0.95, diffOrange, ambiOrange, specOrange).draw(); break;
            case 6: Cube((logic.a[i].y) - (float(coll) / 2 - 0.5), 0, (logic.a[i].x) - (float(row) / 2), 0.95, 0.95, 0.95, diffViolet, ambiViolet, specViolet).draw(); break;
            case 7: Cube((logic.a[i].y) - (float(coll) / 2 - 0.5), 0, (logic.a[i].x) - (float(row) / 2), 0.95, 0.95, 0.95, diffYellow, ambiYellow, specYellow).draw(); break;
            default:
                break;
            }
        }
